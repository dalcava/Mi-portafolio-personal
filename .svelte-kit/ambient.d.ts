...
declare module '$env/static/private' {
	...
	export const VRAY_FOR_3DSMAX2023_MAIN: string;
	export const VRAY_FOR_3DSMAX2023_PLUGINS: string;
	export const VRAY_MDL_PATH_3DSMAX2023: string;
	export const VRAY_SEND_ANONYMIZED_FEEDBACK: string;
	export const VRAY_SEND_FEEDBACK: string;
	export const VRAY_SEND_PERSONALIZED_FEEDBACK: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		USERNAME: string;
		USERPROFILE: string;
		VRAY_FOR_3DSMAX2023_MAIN: string;
		VRAY_FOR_3DSMAX2023_PLUGINS: string;
		VRAY_MDL_PATH_3DSMAX2023: string;
		VRAY_SEND_ANONYMIZED_FEEDBACK: string;
		VRAY_SEND_FEEDBACK: string;
		VRAY_SEND_PERSONALIZED_FEEDBACK: string;
