<script>
  ...
  onMount(() => {
    totalScrollHeight = SLIDE_COUNT * SCROLL_STEP + window.innerHeight;
    ...
    function handleScroll() {
      ...
      // 👉 Mostrar Works cuando el scroll sea 900 o más
      ...
      // 👉 Mostrar About cuando el scroll sea 5200 o más
