...
<script>
  ...
  lenis = new Lenis({
    wrapper: backgroundEl,
    content: backgroundEl.firstElementChild,
    duration: 0.7, // ⚡ menos duración, empieza casi inmediato
    easing: (t) => t, // ⚡ totalmente lineal, responde al instante
    smoothWheel: true,
    smoothTouch: true,
    lerp: 0.15, // ⚡ un poquito más alto para ganar respuesta
    wheelMultiplier: 1.5, // ⚡ fuerza a que el wheel tenga más "empuje"
    touchMultiplier: 1.2, // ⚡ touch más ágil también
  });
