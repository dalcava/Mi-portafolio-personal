...
<section class="body-projects">
  ...
  <section class="content">
    ...
    <div class="gallery">
      <Section2
        title="<strong>Challenges</strong> & Learnings"
        subtitle="Enhancing the simplicity and usability of the payment portal was essential to solving these issues"
        paragraphs={[
        ...
        image="{base}/Recursos/Projects/Aval_Pay_Center/Aval pay description.png"
        Alt="Process image"
      />
      <div class="gallery-row 1">
        <div class="gallery-item">
          <iframe
            src="https://giphy.com/embed/5dYTGLaAGroGtDRI6U"
            width="480"
            height="269"
            frameBorder="0"
            class="giphy-embed"
        ...
        <div class="gallery-item">
          <iframe
            src="https://giphy.com/embed/dozK2FJXCKS9BYj3YU"
            width="480"
            height="269"
            frameBorder="0"
            class="giphy-embed"
