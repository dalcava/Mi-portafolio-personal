...
imageElements.forEach(img => {
  const updateSpan = () => {
    // Espera un momento tras el render
    setTimeout(() => {
      requestAnimationFrame(() => {
        const height = img.offsetHeight; // ← más confiable que getBoundingClientRect en este caso
        const span = Math.ceil(height / rowHeight);
        if (img.parentElement) {
          img.parentElement.style.gridRowEnd = `span ${span}`;
        }
      });
    }, 10); // pequeño retraso para garantizar layout completo
  };

  if (img.complete) {
    updateSpan(); // para imágenes ya cacheadas
  } else {
    ...
    <div class="gallery">
      ...
      <div class="image-gallery">
        <div class="image-gallery-item">
          <img src="/Recursos/Projects/Aval_Pay_Center/Pantallas 1.png" alt="Pantallas 1" />
        </div>
        <div class="image-gallery-item">
          <img src="/Recursos/Projects/Aval_Pay_Center/Pantallas 2.png" alt="Pantallas 2" />
        </div>
        <div class="image-gallery-item">
          <img src="/Recursos/Projects/Aval_Pay_Center/Pantallas 3.png" alt="Pantallas 3" />
        </div>
        <div class="image-gallery-item">
          <img src="/Recursos/Projects/Aval_Pay_Center/Pantallas 4.png" alt="Pantallas 4" />
        </div>
      </div>
