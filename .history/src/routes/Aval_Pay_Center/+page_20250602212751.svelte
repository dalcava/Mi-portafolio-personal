...
gsap.registerPlugin(ScrollTrigger);
  ...
  const description = [
    ...
    "<br> Our focus was in transforming the platform to make user interaction more intuitive and enjoyable. We implemented a cleaner, more accessible design, simplifying navigation and ensuring that every user can quickly and efficiently find what they need."
  ];
