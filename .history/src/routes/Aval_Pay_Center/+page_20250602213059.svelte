...
gsap.registerPlugin(ScrollTrigger);
  ...
  const description = [
    "As part of NTT Data's Experience Design team, I worked as a UX/UI designer on the Aval Pay Center redesign project—currently live and serving numerous users. Aval Pay Center, a key platform for financial transactions, needed significant improvements to address usability hurdles, inconsistent visual identity, and outdated interaction patterns.",
    
    "Our focus was in transforming the platform to make user interaction more intuitive and enjoyable. We implemented a cleaner, more accessible design, simplifying navigation and ensuring that every user can quickly and efficiently find what they need."
  ];
...
gsap.utils.toArray(".split-tittle").forEach((el) => {
 ...
 gsap.utils.toArray(".split-text").forEach((el, i) => {
  ...
  gsap.to(wordSpans, {
    ...
    delay: i * 0.4, // ← clave: escalonado entre párrafos
    duration: 0.4,
    ease: "power4.out"
  });
});
...
<section class="body-projects">
  ...
  <section class="content">
    ...
    <div class="gallery">
      ...
      image="/Recursos/Projects/Aval_Pay_Center/Metodología.png" alt="methodology"
      />
