...
<script>
  ...
  import Accordion from '../components/Secciones home/Accordion.svelte';
  ...
  <div class="about-container">
    ...
    <div class="about-visual">
      ...
      <div class="emoji-label">
        <img src="/tu-path/avatar.png" alt="Avatar" />
        <span>I'm a <strong>UX Designer</strong></span>
      </div>
    </div>

    <!-- Parte Derecha: Contenido -->
    <div class="about-content">
      <h1>My name is David Alfonso López</h1>
      <p>
        Designer and architect passionate about creativity, problem-solving, and user-centered design.
        My professional journey has allowed me to grow as a consultant specializing in UX/UI design
        and motion graphics. I bring expertise in user research, graphic design, and 3D modeling, combined
        with strong consulting and client management skills. I specialize in crafting impactful visual
        solutions, functional interfaces, and meaningful experiences that create connections and solve
        real-world problems.
      </p>

      <h2>Working Experience</h2>
      <ul class="experience-list">
        <li>NTT Data - Europe & Latam</li>
        <li>Construcciones Castañeda</li>
        <li>NTT Data - Europe & Latam</li>
      </ul>
    </div>
