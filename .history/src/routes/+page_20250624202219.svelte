<script>
  ...
  // Registro del plugin de scrollTo
  onMount(() => {
    gsap.registerPlugin(ScrollToPlugin);

    // Animación de loading screen
    ...
    // Inicializar clipPath de transición
    if (transitionOverlay) {
      transitionOverlay.style.clipPath = 'inset(0 0 0 100%)';
    }
  });

  // Scroll animado a una sección (works, about, contact)
  ...
  // Restaurar animación inicial al volver a home
...
<!-- ---------------------------------------------------------------------------------------------------------------------------
---- --------------------------------------------------HTML del Home corregido al 100%--------------------------------------------
---- ----------------------------------------------------------------------------------------------------------------------- -->
