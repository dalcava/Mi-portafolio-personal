...
<script>
  ...
  function smoothScrollTo(targetY, duration = 600) {
    const diff = targetY - scrollY; // Usamos tu scrollY en lugar de window.scrollY
    let startTime = null;
    ...
    function step(timestamp) {
      ...
      window.scrollTo(0, scrollY + diff * easedPercent);
  ...
  // Muy importante: limpiar el event listener al destruir el componente
