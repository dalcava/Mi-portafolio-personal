...
<script>
  ...
  import CircleText from '../../Recursos/Fondos/Circle-text.gif';
...
<div class="background" bind:this={scrollContainer}>
  <div class="hero">
    ...
    <CanvasParticles />
    <img class="video-scroll" src={CircleText} alt="Animated circular text" />
...
.video-scroll {
  ...
  .background {
    ...
    gap: 80px;
    background: linear-gradient(180deg,rgba(93, 0, 255, 1) 35%, rgba(20, 0, 51, 1) 95%);
}
