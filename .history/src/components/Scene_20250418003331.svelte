...
const glassMaterial = new THREE.MeshPhysicalMaterial({
  transmission: 1.25,          // Full transmission for glass
  thickness: 1.0,             // Thickness of the object for internal refraction
  roughness: 0,               // No surface blur
  metalness: 0,               // Non-metal
  reflectivity: 0.7,          // High reflectivity for shiny edges
  ior: 1.5,                   // Index of refraction (glass-like)
  specularIntensity: 1.0,     // Intense specular for sparkle
  color: 0xffffff,            // White base (tint with environment)
  envMapIntensity: 1.5,       // Make the environment bounce stronger
  clearcoat: 1.0,
...
rgbShiftPass.uniforms['amount'].value = 0.0015; // nice subtle prism
