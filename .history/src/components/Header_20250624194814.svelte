  ...
  onMount(() => {
    ...
    if (isHome) {
      ...
      handleScroll = () => {
        ...
        // 🔥 Aquí unimos las dos condiciones
        ...
        {#if isMobile}
          ...
          {#if menuOpen}
            <div class="mobile-menu">
              <div class="icon-button menu work" on:click={() => { document.getElementById('works')?.scrollIntoView({ behavior: 'smooth' }); }}>
                <span>Works</span>
              </div>
              <div class="icon-button menu About" on:click={() => { document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' }); }}>
                <span>About</span>
              </div>
              <div class="icon-button menu contact" on:click={() => { document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }); }}>
                <span>Contact</span>
              </div>
            </div>
          {/if}
