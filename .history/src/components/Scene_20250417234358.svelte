...
const glassMaterial = new THREE.MeshPhysicalMaterial({
  transmission: 1.2,             // Baja transmisión → más opaco
  transparent: true,
  opacity: 0.9,                  // Casi sólido visualmente
  roughness: 0.4,                // Difusión suave de la luz
  metalness: 0,                  // Sin brillo metálico
  thickness: 2,                  // Le da volumen realista
  ior: 1.3,                      // Índice más bajo = más opaco
  reflectivity: 0.1,            // Reflejo sutil
  envMapIntensity: 1.2,
  clearcoat: 0.2,                // Capa externa sutil
  clearcoatRoughness: 0.5,
  color: new THREE.Color(0xffffff).convertSRGBToLinear(), // Blanco opaco
