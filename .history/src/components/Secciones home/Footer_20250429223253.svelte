...
<section class="footer">
    <div class="footer-content">
        ...
        <a href="https://www.artstation.com/dalcava"><i class="fa-solid fa-layer-group"><img src="{base}/Recursos/Footer/Artstation.svg" alt="Artstation" /></a>
        <a href="https://www.behance.net/davidlpez39"><i class="fa-brands fa-Behance"><img src="{base}/Recursos/Footer/Behance.svg" alt="Behance" /></a>
        <a href="https://www.linkedin.com/in/david-a-l%C3%B3pez/"><i class="fa-brands fa-instagram"><img src="{base}/Recursos/Footer/linkedin.svg" alt="linkedin" /></a>
        <a href="https://www.instagram.com/dalcava/"><i class="fa-brands fa-linkedin"><img src="{base}/Recursos/Footer/instagram.svg" alt="instagram" /></a>
        </div>
    </div>
...
.footer-title {
  ...
  background: linear-gradient(45deg, #5D00FF 15%, #8280FF 79%);
...
.gallery-track {
  display: flex;
  width: calc(200% + 4px); /* Duplica el ancho */
...
@media (max-width: 850px) {
  .gallery-image {
    width: calc(100vw / 3); /* Menos imágenes visibles */
  }
}
@media (max-width: 450px) {
  .gallery-image {
    width: calc(100vw / 2); /* Menos imágenes visibles */
  }
}
