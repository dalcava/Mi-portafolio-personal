...
<script>
  ...
  import Slider, { scrollToStart as scrollToStartUX } from '../../components/Slider.svelte';
  import Slider_2, { scrollToStart as scrollToStart3D } from '../../components/Slider_2.svelte';
  ...
  function handleTabChange(event) {
    ...
    // Llamamos al scroll correspondiente
    if (activeTab === 'UX') {
      scrollToStartUX();
    } else {
      scrollToStart3D();
