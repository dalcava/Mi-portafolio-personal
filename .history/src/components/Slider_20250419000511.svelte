<script>
    ...
    function generateScrollRanges(start = 2100, step = 500, count = 8) {
    ...
    <div class="swiper">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" data-url="/Control" on:click={handleClick}>
                ...
                <video autoplay loop muted playsinline class="active-gif">
                    <source src="{base}/Recursos/Slider/UX/Colmena-Active.mp4" type="video/mp4">
