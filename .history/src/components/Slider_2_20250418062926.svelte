...
/* Scrollbar oculto */
.swiper_2 .swiper-horizontal > .swiper-scrollbar,
.swiper_2 .swiper-scrollbar.swiper-scrollbar-horizontal {
    display: none;
}

/* Botones custom */
.swiper_2 .custom-box-left,
.swiper_2 .custom-box-right {
    position: absolute;
    top: 50%;
...
:global(.swiper_2 .swiper-slide-active .static-img),
:global(.swiper_2 .swiper-slide-active .active-gif) {
    border-radius: 16px 0 0 16px;
}
.swiper_2 .swiper-slide:hover .static-img {
