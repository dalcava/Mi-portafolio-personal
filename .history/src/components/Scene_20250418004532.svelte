...
const glassMaterial = new THREE.ShaderMaterial({
  ...
  vertexShader: `
    ...
    void main() {
      ...
      // Simple ripple based on mouse distance
      float distanceFromMouse = distance(vec2(modelViewMatrix * vec4(position, 1.0)).xy, uMouse);
      distortedPosition.z += sin(distanceFromMouse * 20.0) * 0.05;
  ...
  `,
  fragmentShader: `...`, // keep your shader logic here
  transparent: true,
  ...
  glassMaterial.uniforms.uMouse.value.copy(mouse);
