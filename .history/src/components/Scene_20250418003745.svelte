  ...
  metalness: 1
    ...
    if (backgroundEl) {
      backgroundEl.addEventListener('scroll', () => {
        ...
        rgbShiftPass.enabled = shouldBeVisible;
...
rgbShiftPass.uniforms['amount'].value = 0.0015; // Puedes aumentar a 0.002 o más
rgbShiftPass.enabled = false; // Empieza desactivado
