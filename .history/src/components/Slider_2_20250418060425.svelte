<script>
    ...
    import Swiper2 from 'swiper2/bundle';
    import 'swiper2/css/bundle';
    ...
    function handleScrollPositionSync() {
        ...
        if (index !== -1 && swiper2 && swiper2.realIndex !== index) {
            if (!isAnimating) {
                isAnimating = true;
	...
	const slide = event.currentTarget.closest('.swiper2-slide');
    ...
    const navigateSwiper2 = (direction) => {
    ...
    function animateBullet() {
        ...
        document.querySelectorAll('.swiper2-pagination-bullet').forEach(b => (b.innerHTML = ''));

        const active = document.querySelector('.swiper2-pagination-bullet-active');
        if (active) {
    ...
    function toggleQuoteVisibility() {
        ...
        const isFirstSlide = swiper2?.realIndex === 0;
    ...
    /* ----------------------------------------------------------------------------------------------------------
    -------------------------------------------Aquí empieza swiper2 ----------------------------------------------
    -------------------------------------------------------------------------------------------------------------*/

    onMount(() => {
        
        swiper2 = new Swiper2('.swiper2', {
            effect: "slide",
            slidesPerView: '5.7',
            centeredSlides: true,
            initialSlide: 0,
        ...
        swiper2.on('slideChange', () => {
            const ranges = generateScrollRanges();
            const y = ranges[swiper2.realIndex]?.[0]; 
        ...
        swiper2.on('slideChangeTransitionStart', () => updateSlidePositions(true));
        swiper2.on('slideChangeTransitionEnd', () => updateSlidePositions(true));
        swiper2.on('sliderMove', () => requestAnimationFrame(() => updateSlidePositions(false)));
        ...
        document.querySelectorAll('.swiper2-slide').forEach(slide => {
        ...
        document.querySelectorAll(".swiper2-slide").forEach((slide) => {
            ...
            window.addEventListener("mousemove", (e) => {
                if (!slide.classList.contains("swiper2-slide-active")) {
                    removeEffect();
                    return;
                }
            ...
            slide.addEventListener("mouseleave", () => {
                if (slide.classList.contains("swiper2-slide-prev")) {
                    removeEffect();
                    return;
                }
  ...
  <div class="boolean-container">
    ...
    <div class="swiper2">
        ...
        <div class="swiper2-wrapper">
            <div class="swiper2-slide slide-1" data-url="/Control" on:click={handleClick}>
            ...
            <div class="swiper2-slide" data-url="/Control" on:click={handleClick}>
                <div class="image-container static-img">
    ...
    <div class="Swiper2-Extras">

        <div class="control-container">
    <!--       <div class="swiper2-button-container">
...
:global(.swiper2-slide-active) {
    width: 60% !important;
}
:global(.swiper2-slide .grid) {
    opacity: 0 !important;
}
:global(.swiper2-slide-active .grid) {
...
.swiper2-slide-prev .grid-collumn {
    opacity: 0;
    transition: all 0.2s ease;
}

.swiper2-slide-prev .blur {
...
.swiper2-horizontal>.swiper2-scrollbar, .swiper2-scrollbar.swiper2-scrollbar-horizontal {
    position: absolute;
    left: var(--swiper2-scrollbar-sides-offset, 1%);
    bottom: var(--swiper2-scrollbar-bottom, 4px);
    top: var(--swiper2-scrollbar-top, auto);
    z-index: 50;
    height: var(--swiper2-scrollbar-size, 4px);
    width: calc(100% - 2* var(--swiper2-scrollbar-sides-offset, 1%));
    display: none;
}
.custom-box-left,
.custom-box-right {
...
:global(.swiper2-pagination) {
    display: flex;
    justify-content: center;
    pointer-events: none;
}
:global(.swiper2-horizontal>.swiper2-pagination-bullets, .swiper2-pagination-bullets.swiper2-pagination-horizontal, .swiper2-pagination-custom, .swiper2-pagination-fraction) {
    bottom: var(--swiper2-pagination-bottom, 8px);
    top: var(--swiper2-pagination-top, auto);
    left: 0;
    width: 100%;
...
:global(.swiper2-pagination-bullet) {
  width: 8px;
  height: 8px;
...
/* Bullet activo */
:global(.swiper2-pagination-bullet-active) {
...
:global(.swiper2-button-container) {
    display: flex;
    align-items: center;
...
:global(.swiper2-slide-active .static-img) {
    border-radius: 16px 0px 0px 16px;
}
:global(.swiper2-slide-active .active-gif) {
    border-radius: 16px 0px 0px 16px;
}
.swiper2-slide:hover .static-img {
