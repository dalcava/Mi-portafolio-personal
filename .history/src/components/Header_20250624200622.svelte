<script>
  ...
  onMount(() => {
    ...
    if (isHome) {
      // Usa directamente la referencia Svelte en vez de querySelector
      const backgroundEl = scrollContainer;
