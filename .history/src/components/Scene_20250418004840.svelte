...
textureLoader.load(`${base}/Recursos/Slider/3D/Chasms call.webp`, (texture) => {
  const planeGeo = new THREE.PlaneGeometry(8, 6); // Ajusta el tamaño si hace falta
  ...
  imagePlane.position.set(0, 1, -30); // Justo detrás del vidrio
