<script>
    ...
    onMount(() => {
        ...
        swiper_2.on('slideChangeTransitionStart', () => updateSlidePositions(true));
        swiper_2.on('slideChangeTransitionEnd', () => updateSlidePositions(true));
        swiper_2.on('sliderMove', () => requestAnimationFrame(() => updateSlidePositions(false)));

        let correctionTimeout;
        swiper_2.on('touchEnd', () => {
...
<div class="boolean-container">
    ...
    <div class="control-container">
      <!--
      <div class="swiper-button-container_2">
        <div class="swiper-button-prev_2">
          <img src="/Recursos/slider/arrow-left.svg" alt="Previous" class="new-icon" />
        </div>
        <div class="swiper-button-next_2">
...
.image-container::after {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(180deg, rgba(255, 255, 255, 0) 50%, rgba(0, 0, 0, .75) 100%);
